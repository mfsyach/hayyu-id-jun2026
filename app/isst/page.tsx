...
import SectionNav from "./IsstSectionNav";

export const metadata: Metadata = {
  title: "ISST | International Smart Skin Technology | Hayyu Skin Clinic",
  description:
    "International Smart Skin Technology (ISST) adalah framework perawatan kulit Hayyu Skin Clinic untuk diagnosa, program treatment, dan pengukuran hasil yang lebih personal dan terukur.",
  alternates: { canonical: "/isst" },
  openGraph: {
    title: "ISST | International Smart Skin Technology | Hayyu Skin Clinic",
    description:
      "Framework perawatan kulit Hayyu Skin Clinic yang menggabungkan standar formula dan device internasional, SRP, prinsip keamanan, dan pengukuran QuantifiCare.",
...
const pillars = [
  {
    ...
    body: "Bahan, formula, dan alat yang digunakan di Hayyu dipilih dengan prinsip kehati-hatian, standar klinis, dan legalitas yang dapat diverifikasi. Rekomendasi akhir tetap mengikuti hasil konsultasi dokter.",
  ...
  },
  {
    ...
    body: "Efektif tidak harus mengubah karakter wajah. Hayyu mengutamakan rekomendasi yang mempertimbangkan kondisi kulit, kenyamanan, dan keamanan jangka panjang. Cantik asli dirawat, bukan dipaksakan.",
...
const qcParameters = [
  {
    ...
    score: 72,
    beforeImage: "/images/quantificare/generated/wrinkles-before.png",
    afterImage: "/images/quantificare/generated/wrinkles-after.png",
  },
  {
    name: "Pori-pori & tekstur",
    insight: "Memetakan area permukaan kulit yang perlu distabilkan bertahap.",
    score: 64,
    beforeImage: "/images/quantificare/generated/pores-texture-before.png",
    afterImage: "/images/quantificare/generated/pores-texture-after.png",
  },
  {
    name: "Pigmentasi & flek",
    insight: "Mendukung evaluasi noda yang tampak maupun yang mulai terbentuk.",
    score: 78,
    beforeImage: "/images/quantificare/generated/pigmentation-before.png",
    afterImage: "/images/quantificare/generated/pigmentation-after.png",
  },
  {
    name: "Oiliness",
    insight: "Menjadi masukan untuk program acne, sebum, dan perawatan harian.",
    score: 58,
    beforeImage: "/images/quantificare/generated/oiliness-before.png",
    afterImage: "/images/quantificare/generated/oiliness-after.png",
  },
  {
    name: "Volume & elastisitas",
    insight: "Memberi konteks 3D untuk perubahan wajah tanpa mengubah karakter alami.",
    score: 69,
    beforeImage: "/images/quantificare/generated/volume-elasticity-before.png",
    afterImage: "/images/quantificare/generated/volume-elasticity-after.png",
  },
];
...
const timeline = [
  ...
  },
  {
    ...
    desc: "Prosedur dilakukan menggunakan bahan dan alat yang dikurasi sesuai standar klinik dan legalitas yang berlaku. Semua dilakukan di ruang privat oleh staf wanita terlatih, dengan rekomendasi yang menjaga karakter alami wajah.",
  },
  {
    label: "Pilar 03 & 04",
        ...
        <section className="hero-bg relative overflow-hidden pb-20 pt-36 lg:pb-28 lg:pt-44">
          <div className="relative mx-auto grid max-w-content items-center gap-12 px-5 lg:grid-cols-2 lg:px-8 xl:px-0">
            ...
            <div className="relative animate-fade-up lg:pl-6">
              <ImagePlaceholder
                ratio="aspect-[4/5]"
                alt="Perangkat QuantifiCare LifeViz dan visualisasi hasil pemindaian kulit wajah 3D di Hayyu Skin Clinic"
